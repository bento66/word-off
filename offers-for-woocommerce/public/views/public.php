 ...
 */
?>
<div class="nm-row-full nm-row-flex">
<div class="nm_column col-sm-5 tab_custom_offer_img d-none">
  <img src="/wp-content/themes/savoy/img/offer-side.png" alt="" width="500" height="600"/>
</div>
    	...
    	<div class="make-offer-form-intro">
            ...
            <?php
                if($is_counter_offer) {
                    ...
                    $intro_html = '<h2 class="cd-popupx-tt">' . $tab_title . '</h2>';
                    $intro_html .= '<div class="make-offer-form-intro-text">' . __('To make an offer please complete the form', 'offers-for-woocommerce') . '</div>';
                }
        ...
        <form id="woocommerce-make-offer-form" name="woocommerce-make-offer-form" method="POST" autocomplete="off" action="">
            ...
            <div class="woocommerce-make-offer-form-section">
                ...
                <div class="">
                    <div class="angelleye-input-group">
                        ...
                        <input type="text" placeholder="Offer Price*" name="offer_price_each" id="woocommerce-make-offer-form-price-each" pattern="([0-9]|\$|,|.)+" data-a-sign="$" data-m-dec="2" data-w-empty="" data-l-zero="keep" data-a-form="false" required="required" />
                    </div>
                </div>
                    </div>
            ...
            <?php
                    foreach ($button_display_position as $key => $value) {
                        ...
                        if($value=='display_setting_make_offer_form_field_offer_name'){ ?>
                            ...
                            <div class="woocommerce-make-offer-form-section">
                                <input type="text" id="offer-name" placeholder="Full Name*" name="offer_name" required="required" <?php echo ($is_counter_offer) ? ' disabled="disabled"' : '' ?> value="<?php echo (isset($offer_name)) ? $offer_name : ''; ?>" />
                            </div>
                        ...
                        if($value=='display_setting_make_offer_form_field_offer_email'){ ?>
                            ...
                            <div class="woocommerce-make-offer-form-section">
                                <input type="email" placeholder="Email*" name="offer_email" id="woocommerce-make-offer-form-email" required="required" <?php echo ($is_counter_offer) ? ' disabled="disabled"' : '' ?> value="<?php echo (isset($offer_email)) ? $offer_email: ''; ?>" />
                            </div>
            ...
            <?php if(!empty($button_display_options['display_setting_make_offer_form_field_offer_notes']) && $is_anonymous_communication_enable == false ) { ?>
                <div class="woocommerce-make-offer-form-section">
                    ...
                    ?>
                    <textarea name="offer_notes" placeholder="Offer Notes (optional)" id="angelleye-offer-notes" rows="2" <?php echo $offer_notes_required; ?>></textarea>
                </div>
            <?php } else { ?>
